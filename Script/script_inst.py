...
my_env["LD_LIBRARY_PATH"] = "/nas/mrocariu/CPLEX_Studio1263/opl/bin/x86-64_linux/"
=======
...
for dat in range(201,203):
    ...
    with open(res_file,'w') as output_f:
        print("Middle Python")
        start = time.time()
        p = subprocess.Popen(["./ConsoleApplication1", mod_file, data_file, out_file, plot_file, glob_file],stdout=output_f, env=my_env)
        p.wait()
