...
main
{
	...
	var pfile = new IloOplOutputFile("process_lazy_pure"+thisOplModel.Id.toString()+"_"+thisOplModel.model.toString()+"_"+thisOplModel.T.toString()+".txt");
	//output result file
	var ofile = new IloOplOutputFile("result_lazy_pure"+thisOplModel.Id.toString()+"_"+thisOplModel.model.toString()+"_"+thisOplModel.T.toString()+".txt");
	...
	******************************/	
	...
	var supply = new Array(thisOplModel.Time); 
