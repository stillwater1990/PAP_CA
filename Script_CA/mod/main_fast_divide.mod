 ...
 *********************************************/
 ...
 int zinit[RQ][TimeE] = ...;
 int model = ...;
 sorted {int} TimeIB = asSet(0..-1);
 
main
{
	thisOplModel.generate();
	var pfile = new IloOplOutputFile("process_fast"+thisOplModel.Id.toString()+"_"+thisOplModel.model.toString()+"_"+thisOplModel.T.toString()+".txt");

	var ofile = new IloOplOutputFile("result_fast"+thisOplModel.Id.toString()+"_"+thisOplModel.model.toString()+"_"+thisOplModel.T.toString()+".txt");
